...
_API Design Matters_ is also the home for David's consultancy
practice of the same name, where David help companies
...
In this _API Design Matters_ blog, David focuses on RESTful web services, but
many of the concepts apply to other API styles like AsyncIO, GRPC, and
GraphQL. Articles will pull from David's 13+ years experience designing
...
A good (or great) Developer Experience (DX) is an important aspect of API design, and _API Design Matters_ will often discuss the interplay of API design and DX: how and why API Design matters to DX.

## Intro

_API Design Matters_ begins with an extensive series on [_The Language of API Design_](/the-language-of-api-design). This series will focus on the API First process to complete learning projects with the OpenAPI 3 Specification-why API Design with OpenAPI matters.
...
Enough about me. Let's hear from you - what topics of API Design are
